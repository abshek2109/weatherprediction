...
def tell_weather() :
	...
	api_key = "bcbab04440acac3c64230c92cb92930b"
...
if __name__ == "__main__" :
	...
	temp_field.grid(row = 3, column = 1, ipadx ="150", ipady ="150")
	#atm_field.grid(row = 10, column = 1, ipadx ="100")
